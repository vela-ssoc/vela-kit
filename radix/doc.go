// package rock-radix-go implements an Adapative Radix Tree(ART) in pure Go.
...
//  import (
//     "fmt"
//     "github.com/plar/go-adaptive-radix-radix"
//  )
//
//  func main() {
//
//     radix := art.New()
//
//     radix.Insert(art.Key("Hi, I'm Key"), "Nice to meet you, I'm Value")
//     value, found := radix.Search(art.Key("Hi, I'm Key"))
//     if found {
//         fmt.Printf("Search value=%v\n", value)
//     }
//
//     radix.foreach(func(node art.Node) bool {
//         fmt.Printf("Callback value=%v\n", node.Data())
//         return true
//     }
//
//     for it := radix.Iterator(); it.HasNext(); {
//         value, _ := it.Next()
