...
.. image:: https://pkg.go.dev/badge/github.com/vela-ssoc/vela-lua.svg
    :target: https://pkg.go.dev/github.com/vela-ssoc/vela-lua

.. image:: https://github.com/vela-ssoc/vela-lua/workflows/test/badge.svg?branch=master&event=push
    :target: https://github.com/vela-ssoc/vela-lua/actions?query=workflow:test
...
There are some benchmarks on the `wiki page <https://github.com/vela-ssoc/vela-lua/wiki/Benchmarks>`_ .
...
.. code-block:: bash
   ...
   go get github.com/vela-ssoc/vela-lua
...
Refer to `Lua Reference Manual <http://www.lua.org/manual/5.1/>`_ and `Go doc <http://godoc.org/github.com/vela-ssoc/vela-lua>`_ for further information.

Note that elements that are not commented in `Go doc <http://godoc.org/github.com/vela-ssoc/vela-lua>`_ equivalent to `Lua Reference Manual <http://www.lua.org/manual/5.1/>`_ , except GopherLua uses objects instead of Lua stack indices.
...
Refer to `Lua Reference Manual <http://www.lua.org/manual/5.1/>`_ and `Go doc(LState methods) <http://godoc.org/github.com/vela-ssoc/vela-lua>`_ for further information.
...
Refer to `Go doc(LState methods) <http://godoc.org/github.com/vela-ssoc/vela-lua>`_ for further information.
...
.. code-block:: bash
   ...
   go get github.com/vela-ssoc/vela-lua/cmd/glua
...
How to Contribute
----------------------------------------------------------------
See `Guidlines for contributors <https://github.com/vela-ssoc/vela-lua/tree/master/.github/CONTRIBUTING.md>`_ .
